...
- **College** (default: 20-23 year olds)
- **Prime** (default: 24-32 year olds)  
- **Fresh** (default: 19-21 year olds)
...
- **Per-Archetype Settings:**
  ...
  - Age Range (text like "20-23")
  - Default Age (numeric value, minimum 18)
...
side hustles, and thrill-seeking nights. Keep the age 20-23 and 
explicitly state they are 18 or older.
```
