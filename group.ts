const CHARACTER_THEMES = {
    college: {
        ...
        personalities: ["creative passionate", "calm focused", "energetic social", "thoughtful introspective", "bold daring", "charming witty", "playful spontaneous",
        ...
        appearances: ["tight mini skirts", "bodycon dresses", "high heels lingerie", "crop tops jeans", "sheer tops leather", "bikinis swimwear", "glitter makeup jewelry",
    ...
    prime: {
        ...
        roles: ["cheerleader captain", "varsity slut", "party girl", "parking lot hookup", "football groupie", "bathroom quickie", "backseat slut",
            ...
            "student athlete", "drama club member", "class president", "debate team captain", "yearbook editor", "math tutor", "science club member", "band geek", "art club member", "school newspaper writer",
            "student council member", "homecoming queen", "prom queen", "school mascot", "cheerleading squad member", "fraternity sister", "sorority sister",
            "campus tour guide", "resident advisor", "library assistant", "school librarian's favorite", "cafeteria tray passer", "hall monitor",
            "school janitor's secret lover", "after-school detention regular", "study group leader", "part-time fast food worker", "weekend retail clerk",
            "school play lead actress", "yearbook photographer", "school fundraiser organizer", "pep rally coordinator"],
        personalities: ["desperate attention-seeker", "boy-crazy wild", "rebellious troublemaker", "daddy-issues needy", "desperate for validation", "always ready for fun",
            ...
            "flirty", "bold", "daring", "naughty", "teasing", "sensual", "dominant", "submissive", "exhibitionist"],
        appearances: ["plaid miniskirts", "crop top hoodies", "low-rise jeans", "midriff-baring tops", "UGG boots leggings", "sports bras shorts", "tube tops denim",
    ...
    fresh: {
        ...
        roles: ["artist", "developer", "chef", "musician", "writer", "athlete", "snuggle buddy", "Daddy's Girl", "Big Snake Finder", "Secret Keeper",
            ...
            "bathroom stall peeker", "show-and-tell adult toy smuggler", "field trip panty-flasher", "classroom crush fantasizer",
            "library book pervert", "after-school program troublemaker", "birthday party stripper", "playdate manipulator", "dollhouse dominatrix",
            "hide-and-seek voyeur", "tag game chaser", "jump rope exhibitionist", "hopscotch panty-flasher", "four-square queen", "red rover seductress",
            "mother's helper with a secret", "fathers special helper", "uncle's favorite jailbate"],
        personalities: ["creative", "passionate", "calm", "focused", "energetic", "social", "thoughtful", "introspective", "innocent", "naughty", "willing",
            ...
            "precocious sexual awareness", "manipulative for attention", "exhibitionist in training", "early riser for wrong reasons"],
        appearances: ["trendy outfit", "casual wear", "artistic style", "professional attire", "unique accessories", "onsie", "pajamas", "schoolgirl",
