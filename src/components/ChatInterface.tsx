...
export function ChatInterface({
  ...
  useEffect(() => {
    ...
    if (g.addEventListener)
      g.addEventListener("open-group-chat-creator", handler);
    return () => {
      if (g.removeEventListener)
        g.removeEventListener("open-group-chat-creator", handler);
    };
  }, []);
  ...
  useEffect(() => {
    ...
    const handler = () => {
      ...
      getSessionMessages(effectiveSessionId)
        .then(setMessages)
        .catch(() => {
          /* ignore */
        });
    ...
    if (g?.addEventListener) {
      ...
      return () =>
        ...
        g.removeEventListener("chat-sessions-updated", handler);
    }
    return undefined;
  ...
  useEffect(() => {
    if (activeTab === "chat") {
      ...
      const g = globalThis as unknown as {
        document?: { getElementById: (id: string) => Elem };
      };
      const el: Elem = g.document
        ? g.document.getElementById(scrollAnchorId)
        : null;
  ...
  const handleAutoPlay = async () => {
    ...
    try {
      ...
      const scenarioMessage =
        scenePrompt ||
        "Continue the conversation naturally based on the current scene.";
  ...
  const characterSessionList = React.useMemo(() => {
    ...
    return sessions
      .filter(
        (s) =>
          s.type === "individual" && s.participantIds.includes(mainCharacter.id)
      )
        ...
        <div className="text-center space-y-4 max-w-sm">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Select a character from the sidebar to view their profile.
            </p>
          </div>
  ...
  return (
    <div
      className={`h-full flex flex-col bg-[#1a1a1a] text-white ${isGroup ? "group-chat-layout" : ""}`}
    >
      {!isGroup && (
      ...
      {/* Header */}
      <div
        className={`h-[73px] border-b border-[rgba(255,255,255,0.04)] px-4 flex items-center justify-between flex-shrink-0 ${isGroup ? "bg-[#141414]" : "bg-[#1a1a1a]"}`}
      >
            ...
            <div className="flex items-center gap-2">
              ...
              {session && session.participantIds.length > 5 && (
                <div className="text-[10px] text-gray-400">
                  +{session.participantIds.length - 5}
                </div>
              )}
              <div className="ml-2">
                <h2 className="text-white font-semibold text-sm">Group Chat</h2>
                <p className="text-[#ff1372] text-[10px] uppercase tracking-wide">
        ...
        <div className="flex items-center gap-2 relative">
          <Button
            ...
            aria-label="Character Chats"
          >
            <MessageCircle
              size={16}
              className={showSessionList ? "text-[#ff1372]" : "text-gray-400"}
            />
          </Button>
          ...
          <div className="flex w-full items-center justify-between gap-6 max-w-[980px] mx-auto text-xs">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 w-full">
                <div className="flex-1 h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    className="h-2 bg-gradient-to-r from-red-400 to-[#ff1372]"
                    style={{ width: `${stats.love}%` }}
                  />
                </div>
                <span className="text-red-400 font-semibold w-10 text-right">
                  {stats.love}%
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 w-full">
                <div className="flex-1 h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${stats.wet}%` }}
                  />
                </div>
                <span className="text-blue-400 font-semibold w-10 text-right">
                  {stats.wet}%
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 w-full">
                ...
                <span className="text-green-400 font-semibold w-10 text-right">
                  {stats.trust}%
                </span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[rgba(38,38,38,0.6)] rounded-xl p-4 border border-[rgba(55,65,81,0.3)]">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  {mainCharacter.description ||
                    "Sarah is a talented UX/UI designer with a passion for creating beautiful and functional digital experiences. She has a warm personality and loves working with innovative teams. Her creative mind is always buzzing with new ideas, and she approaches every project with enthusiasm and dedication."}
                </p>
              </div>
              ...
              <div className="bg-[rgba(38,38,38,0.6)] rounded-xl p-4 border border-[rgba(55,65,81,0.3)]">
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-3">
                  {mainCharacter.appearance ||
                    "Sarah has long, silky black hair that cascades down to her shoulders. Her expressive brown eyes sparkle with intelligence and warmth. She has a petite frame and carries herself with confidence and grace."}
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="secondary"
                    className="bg-[rgba(102,126,234,0.2)] text-[#667eea] border-none"
                  >
                    Petite
                  </Badge>
                  <Badge
                    variant="secondary"
                    className="bg-[rgba(236,72,153,0.2)] text-[#ff1372] border-none"
                  >
                    Brown Eyes
                  </Badge>
                  <Badge
                    variant="secondary"
                    className="bg-[rgba(79,172,254,0.2)] text-[#4facfe] border-none"
                  >
                    Black Hair
                  </Badge>
                  <Badge
                    variant="secondary"
                    className="bg-[rgba(67,233,123,0.2)] text-[#43e97b] border-none"
                  >
                    Elegant
                  </Badge>
                </div>
              ...
              <div className="bg-[rgba(38,38,38,0.6)] rounded-xl p-4 border border-[rgba(55,65,81,0.3)]">
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-3">
                  {mainCharacter.personality ||
                    "Sarah is naturally curious and loves learning new things. She's empathetic and always tries to understand others' perspectives. Her creative nature makes her approach problems from unique angles, and she has a gentle but determined personality."}
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="secondary"
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-[rgba(250,112,154,0.2)] text-[#fa709a] border-none"
                  >
                    Gentle
                  </Badge>
                </div>
              ...
              <div className="bg-[rgba(38,38,38,0.6)] rounded-xl p-4 border border-[rgba(55,65,81,0.3)]">
                ...
                <div className="bg-[rgba(15,15,15,0.7)] rounded-lg p-3 mb-4">
                  <h4 className="text-[#667eea] text-sm font-medium mb-2">
                    Story Summary
                  </h4>
                  <p className="text-gray-300 text-xs leading-relaxed">
                    Sarah joined the creative community 6 months ago. She's been
                    working on building her portfolio and has shown remarkable
                    growth in her design skills. Recently, she's been more open
                    about sharing her personal thoughts and experiences.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-300 text-xs">
                        Shared her first personal design project
                      </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-300 text-xs">
                        Had a deep conversation about creative inspiration
                      </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-300 text-xs">
                        Reached a milestone in trust level
                      </p>
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-gray-400">
                  Tell Wingman what scene to set up. He'll ask follow-up
              ...
              <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-xl p-6 text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold text-white">
                  Scene Director Coming Soon
                </h3>
                <p className="text-sm text-gray-300 leading-relaxed">
                  The Scene Director feature is currently available in the{" "}
                  <strong>Wingman sidebar</strong> on desktop (screens 1024px+).
                </p>
                <div className="bg-black/30 rounded-lg p-4 text-left space-y-3">
                  ...
                  <ol className="text-sm text-gray-300 space-y-2 list-decimal list-inside">
                    ...
                    <li>
                      When ready, Wingman generates the scene and starts it in
                      chat
                    </li>
                  </ol>
                </div>
                <div className="pt-2">
                  <Badge
                    variant="outline"
                    className="text-xs text-purple-400 border-purple-500/50"
                  >
                    ...
                    <div className="flex items-start gap-3 text-left">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-400 mt-1">
                          Set custom scene prompts and character-specific hidden
                          instructions in the chat tab
                        </div>
                      </div>
                    </div>
                  </Button>
              ...
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4 space-y-3">
                <h4 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">
                  Example Commands (Desktop Wingman)
                </h4>
        ...
        {(activeTab === "chat" || isGroup) && (
          <div className="flex flex-col h-full">
            ...
            <Collapsible
              ...
              onOpenChange={setScenePromptOpen}
              className="border-b border-neutral-800"
            >
              <CollapsibleTrigger asChild>
                <Button
                  variant="ghost"
                  className="w-full justify-between px-4 py-2 h-auto hover:bg-neutral-800/50"
                >
                  <div className="flex items-center gap-2">
                    {scenePromptOpen ? (
                      <CaretDown size={16} />
                    ...
                    <span className="text-sm font-medium">
                      Scene Prompt & Character Instructions
                    </span>
                    {scenePrompt && (
              ...
              <CollapsibleContent className="p-4 space-y-4 bg-neutral-900/50">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    This scenario context will be added to all character
                ...
                {sessionCharacters.length > 0 && (
                  <div className="space-y-3">
                    ...
                    {sessionCharacters.map((char) => (
                      <div
                        key={char.id}
                        className="space-y-2 p-3 bg-neutral-800/50 rounded-lg border border-neutral-700"
                      >
                        <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs text-gray-500">
                      These hidden prompts are private to each character and
                      override their global hidden prompt for this chat only.
                    </p>
                  </div>
                )}
              </CollapsibleContent>
              ...
              <div className="space-y-4">
                {messages.map((m) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`max-w-[70%] rounded-2xl px-4 py-2 text-sm whitespace-pre-wrap ${isUser ? "bg-[#ff1372] text-white" : "bg-neutral-800 text-gray-200 border border-neutral-700"}`}
                      >
                        {m.content}
                      </div>
                    </div>
            ...
            <form
              onSubmit={handleSend}
              className="p-3 border-t border-neutral-800 flex gap-2 bg-[#111]"
            >
              <Input
                value={chatInput}
              ...
              <Button
                ...
                variant="secondary"
                className="bg-[#ff1372] hover:bg-[#ff1372]/80 text-white border-none"
              >
                Send
              </Button>
            </form>
